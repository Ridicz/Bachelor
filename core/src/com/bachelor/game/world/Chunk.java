...
import com.bachelor.game.utils.ChunkAndBlockPosition;
...
public class Chunk {
  ...
  public void setBlockPlayer(Block selectedBlock, Side side, BlockType type) {
    ...
    localChunkAndBlockPosition.getChunk().getVisibleBlocks().add(block);
  ...
  public void addVisibleBlock(IntegerPosition position) {
    ...
    visibleBlocks.add(storage[x][position.getY()][z]);
    rebuildModel = true;
  }
